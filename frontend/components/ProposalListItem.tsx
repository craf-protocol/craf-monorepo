...
export function ProposalListItem(props: ProposalListItemProps) {
    return (<li key={props.contractAddress}>
        <Link href={`/dashboard/proposal/${props.contractAddress}`}>
                ...
                <div className="flex items-center px-4 py-4 sm:px-6">
                    <div className="flex min-w-0 flex-1 items-center">
                        ...
                        <div className="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                            <div>
                                <p className="truncate text-sm font-medium text-indigo-600">{props.title}</p>
                            ...
                            <div className="hidden md:block">
                                <div>
                                    <p className="text-sm text-gray-900">
                                        Deployed on<time dateTime={props.deployedDate}>{props.deployedDate}</time>
                                    </p>
